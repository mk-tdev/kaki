...
const examples = ["Help me use an app", "Walk with me", "Fix something small", "Teach or learn a skill"];
...
export default function AskPage() {
  ...
  async function publishMission() {
    ...
    try {
      const mission = await addMission({ title: draft.title, originalRequest: draft.originalRequest, category: draft.category, language: draft.language, durationMinutes: draft.durationMinutes, location: draft.location, scheduledAt: tomorrow.toISOString(), summary: draft.summary, guide: draft.guide, safetyLevel: draft.safetyLevel });
